# This file is to develop our random baselines for multilabel setting
...
########### PARAMETER SETTING ############
sampling_size = [40,80,100,200,400,1000]
reporting_score = True
use_mode = "cosine"
...
if __name__ == "__main__":
    ...
    for x in range(len(positive_path)):
        ...
        test_pred_all = meanPred(mode = use_mode, label_mode = 1, labels = torch.tensor([[1,1],[1,0],[0,1],[0,0]]))

        test_baseline(positive_path[x], sampling_size = sampling_size, num_cond = 2, dset_all = dset_all, predictor = test_pred_all)
